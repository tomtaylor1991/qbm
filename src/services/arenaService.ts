...
function makeEnemyLoadout(difficulty:"EASY"|"MEDIUM"|"HARD"):BattleLoadout{
  ...
  const bands=difficulty==="EASY"?[.45,.8]:difficulty==="MEDIUM"?[.2,.55]:[0,.3];
